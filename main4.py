...
while carryOn:
    ...
    for event in pygame.event.get(): # User did something
        ...
        if game_state == "INTRO":
            ...
            text_display(font = 'Consolas', font_size = 25, text="1) The Player who first to score "+ str(max_score) + " points WINS" , text_color = (255,255,255), text_pos = (100,350))
    ...
    if keys[pygame.K_w]:
        paddleA.moveUp(speed_control)
    if keys[pygame.K_s]:
        paddleA.moveDown(speed_control)
    if keys[pygame.K_UP]:
        paddleB.moveUp(speed_control)
    if keys[pygame.K_DOWN]:
        paddleB.moveDown(speed_control)
